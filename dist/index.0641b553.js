...
const db = _database.getDatabase(app); //Databasen
const dbRef = _database.ref(db); //En referens till hela databasen
...
},{"firebase/app":"5wGMN","firebase/database":"bpqHw"}],"5wGMN":[function(require,module,exports) {
